...
install -d -o greentree -g greentree -m 0750 /var/www/greentree /var/lib/greentree /var/lib/greentree/backups /var/lib/greentree/public/assets/token /var/log/greentree
