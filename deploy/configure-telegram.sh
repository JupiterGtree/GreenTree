...
curl -fsS -X POST "$api/setMyCommands" --data-urlencode 'commands=[{"command":"start","description":"Open Green Tree"},{"command":"buy","description":"Buy GTREE"},{"command":"connect","description":"Connect wallet"},{"command":"price","description":"Live price"},{"command":"activity","description":"Recent activity"},{"command":"support","description":"Contact support"},{"command":"status","description":"Service status"},{"command":"help","description":"Help"},{"command":"cancel","description":"Cancel"}]' >/dev/null
