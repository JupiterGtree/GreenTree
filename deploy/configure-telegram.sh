...
curl -fsS -X POST "$api/setMyCommands" --data-urlencode 'commands=[{"command":"start","description":"Open Green Tree"},{"command":"buy","description":"Buy GTREE"},{"command":"connect","description":"Connect wallet"},{"command":"mygtree","description":"My GTREE"},{"command":"history","description":"Purchase history"},{"command":"price","description":"Live price"},{"command":"activity","description":"Recent activity"},{"command":"support","description":"Contact support"},{"command":"partnership","description":"Partnership"},{"command":"status","description":"Service status"},{"command":"admin","description":"Admin operations"},{"command":"help","description":"Help"},{"command":"cancel","description":"Cancel"}]' >/dev/null
